...
function _injectorBindings(appComponentType) {
    ...
    return [
        ...
        di_1.bind(shadow_dom_strategy_1.ShadowDomStrategy)
            .toFactory(function (styleInliner, styleUrlResolver, doc) { return new emulated_unscoped_shadow_dom_strategy_1.EmulatedUnscopedShadowDomStrategy(styleInliner, styleUrlResolver, doc.head); }, [style_inliner_1.StyleInliner, style_url_resolver_1.StyleUrlResolver, dom_renderer_1.DOCUMENT_TOKEN]),
